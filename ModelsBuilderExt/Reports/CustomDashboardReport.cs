...
namespace CustomModelsBuilder.Reports;

internal class CustomDashboardReport
{
    private readonly ModelsBuilderSettings _config;
    private readonly ModelsGenerationError _mbErrors;
    private readonly OutOfDateModelsStatus _outOfDateModels;

    public CustomDashboardReport(IOptions<ModelsBuilderSettings> config, OutOfDateModelsStatus outOfDateModels,
